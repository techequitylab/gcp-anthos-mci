...
#
################################################################################
######                Explore Anthos Multi-Cluster Ingress                ######
################################################################################
...
mkdir -p `pwd`/gcp-anthos-mci > /dev/null 2>&1
export PROJDIR=`pwd`/gcp-anthos-mci
export SCRIPTNAME=gcp-anthos-mci.sh
...
export ASM_INSTALL_SCRIPT_VERSION=1.18
